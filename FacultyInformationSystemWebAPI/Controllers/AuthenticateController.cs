    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginModel model)
        {
            ...
            if (user != null && await userManager.CheckPasswordAsync(user, model.Password))
            {
                ...
                // Check if model is valid or not, if not valid return bad request
                if (!ModelState.IsValid) return BadRequest(model);

                var userdata = _db.Faculties.FirstOrDefault(cust => cust.UserName == model.Username);
                                                               
                var authClaims = new List<Claim>
                {
                    
                    new Claim(JwtRegisteredClaimNames.Jti, userdata.UserName),
                    new Claim(JwtRegisteredClaimNames.Jti, userdata.FacultyId.ToString()),
                    new Claim(JwtRegisteredClaimNames.Jti, userdata.FirstName),
                    new Claim(JwtRegisteredClaimNames.Jti, userdata.LastName)
        ...
        public async Task<IActionResult> RegisterFaculty([FromBody] RegisterModel model)
        {
            ...
            return Ok(new Response { Status = "Success", Message = "Faculty User created successfully!" });
        }
    }
}
